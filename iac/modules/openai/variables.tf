...
# variable "ai_pep_name" {
#   description = "The name of the Private Endpoint for Open AI account"
#   type        = string
#   default = ""
# }

# variable "ai_vnet_name" {
#   description = "The name of the Virtual Network for Open AI account"
#   type        = string
#   default = ""
# }

# variable "ai_rg_name" {
#   description = "The name of the Resource Group for Virtual Network of Open AI account"
#   type        = string
#   default = ""
# }

# variable "ai_subnet_name" {
#   description = "The name of the Subnet of Open AI account"
#   type        = string
#   default = ""
# }

# variable "ai_nsg_name" {
#   description = "The name of the NSG of Open AI account"
#   type        = string
#   default = ""
# }

# variable "network_access_option" {
#   description = "Select network access option: all, selected, or disabled"
#   type        = string
#   default     = "selected"
# }

# variable "security_rules" {
#   description = "A list of security rules for Application Gateway."
#   type = list(object({
#     name                       = string
#     priority                   = number
#     direction                  = string
...
# variable "key_name" {
#   description = "The name of the key for the OpenAI deployment"
#   type        = string
# }